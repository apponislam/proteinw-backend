...
const getFAQById = async (faqId: string) => {
    ...
    if (!faq) throw new ApiError(httpStatus.NOT_FOUND, "Begärd FAQ hittades inte eller har raderats.");
    return faq;
};
...
const deleteFAQ = async (faqId: string) => {
    ...
    if (!faq) throw new ApiError(httpStatus.NOT_FOUND, "Begärd FAQ hittades inte eller har redan raderats.");
    return faq;
};
