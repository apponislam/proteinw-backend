...
router.post("/", auth, authorize(["SUPER_ADMIN", "ADMIN"]), uploadProductImages, productControllers.createProduct);
...
router.patch("/:productId", auth, authorize(["SUPER_ADMIN", "ADMIN"]), uploadProductImages, productControllers.updateProduct);
